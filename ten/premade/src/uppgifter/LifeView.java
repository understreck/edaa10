...
public class LifeView extends Frame {
	...
	/**
	 * Ritar upp de fixa delarna av spelplanen (rutntet, generationsrknaren och
	 * knapparna)
	 */
	...
	/**
	 * Vntar tills anvndaren klickar med musen. Ger: 1: Klick i ruta på
	 * spelplanen. Index fr rutan kan hmtas med getRow och getCol 2: Klick i
